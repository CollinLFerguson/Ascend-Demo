...
<div style="padding-right:10px; padding-bottom:10px overflow-y:show !important;">
    <PreviewProgramsTable supervisorId={data?.staffKey} permissionLevel={currentUser?.permissions} showSeeMore={false} limit={null}> </PreviewProgramsTable> <!-- Add callback for fetching staff associated with this user -->
</div>