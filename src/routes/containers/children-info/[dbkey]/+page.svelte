...
<PreviewChildrenTable supervisorId={data?.staffKey} permissionLevel={currentUser?.permissions} showSeeMore={false} limit={null}> </PreviewChildrenTable> <!-- Add callback for fetching staff associated with this user -->
</div>